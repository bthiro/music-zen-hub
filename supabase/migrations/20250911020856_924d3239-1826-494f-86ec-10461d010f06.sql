...
DROP POLICY IF EXISTS "Professores podem gerenciar suas configurações próprias" ON public.configuracoes_professor;
DROP POLICY IF EXISTS "Admins podem ver todas configurações" ON public.configuracoes_professor;
